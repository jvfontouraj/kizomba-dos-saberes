          ...
          <div className="flex flex-col gap-5">
            ...
            <article className="flex flex-col gap-3">
              <p>
                ...
                ao departamento de História da Universidade Federal de Sergipe.
              </p>
              <p>
                O projeto foi ﬁnanciado pela Fapitec, através do edital
                n.09/2021, para o desenvolvimento de tecnologias digitais para o
                ensino, em parceria com a Secretaria de Educação do estado de
                Sergipe.
              </p>
              <p>
                Ao longo de dois anos, realizamos atividades de ensino, pesquisa
                e extensão para a elaboração do conteúdo do site.
              </p>
            </article>
          </div>
      ...
      <div className="relative h-fit mt-20 pb-40 z-10 max-w-7xl w-full px-20 flex">
        <div className="w-full h-fit flex justify-between bg-[#28a346] text-neutral-50 px-20 py-10">
          ...
          <div className="w-1/2 flex flex-col gap-3">
            ...
            <div className="flex flex-col">
              <h3 className="text-[#e7c102] font-bold">Projeto Gráfico Site</h3>
              <span>Folha Verde Design</span>
            </div>
            <div className="flex flex-col">
              <h3 className="text-[#e7c102] font-bold">Desenvolvimento Site</h3>
